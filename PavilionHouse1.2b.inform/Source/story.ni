"Rogers Rd" by Dan Bowen,  Version 1.2beta
...
Say "You are in a house in the countryside.  You are into electronics, and it is [time of day]";
...
When Night begins: 
	...
	Now the red hose is nowhere;
	Now the blue hose is nowhere; 
...
The front yard is north of the Front porch.  "[if Night is happening]In the sky you notice a bright point of light creeping overhead.[otherwise]It is a nice bright day out here." The front yard hydrant is a device. The front yard hydrant is fixed in place. the description of the front yard hydrant is "A gray metal pipe topped with a blue handle.  A blue garden hose is firmly rusted on to the output threads."  The blue hose is fixed in place.  The description of the blue hose is "The blue hose is connected to the hydrant permanently and snakes over into the west side yard. "
...
The middle back yard is south of the back yard hill.   The back yard hydrant is a device. The back yard hydrant is fixed in place. the description of the back yard hydrant is "A gray metal pipe topped with a red handle.  A red garden hose is firmly rusted on to the output threads."   The red hose is fixed in place.  The description of the red hose is "The red hose is connected to the hydrant permanently and snakes over into the west side yard."
