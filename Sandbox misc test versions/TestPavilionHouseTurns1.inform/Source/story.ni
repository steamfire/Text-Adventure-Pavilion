...
Indoors is a region.    The radiostation, The cellar, The garage, The ham shack, The back hallway, The New room east, The New room west, the kitchen, The dining room, The living room, The Foyer, The Hall bathroom, Dad's bathroom , Dad's room, Michael's room, The Hallway, Danny's Bedroom and The Furnace room are in the indoors.
...
After switching on the heavy UHF radio:
	...
	if the player is carrying the brown book:
		...
		";
		pause the game;
		center  "All buildings are to be irradiated from space by Vogon Pest Control at 11:30PM.  Humans are advised to shelter in forests to avoid certain doom.";
		say paragraph break;
		say paragraph break;
		say paragraph break;
		say "You have discovered a sentient satellite. You feel a sense of accomplishment and satisfied curiosity.";
		end the story finally saying "THE END.  Good Job!";
	Otherwise:
